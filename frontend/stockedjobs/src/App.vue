    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center h-full">
          <button type="button" class="text-amber-50 bg-emerald-500  h-10">Login</button>
          <button type="button" class="text-amber-50 bg-emerald-500 mx-8 px-5 h-10">Applications</button>
